...
<div class="x_panel" >
                ...
                <div class="x_title">
                    <div class="panel-title">
					 <?php echo get_phrase('help_information_page'); ?>
					</div>
					</div>
                            ...
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu dropdown-primary pull-right" role="menu">
                                 ...
                                 <a href="#" onclick="showAjaxModal('<?php echo base_url();?>index.php?modal/popup/modal_edit_help_link/<?php echo $row['helplink_id'];?>');">
                                    ...
                                    <!-- DELETION LINK -->
                                    <li>
                                        <a href="#" onclick="confirm_modal('<?php echo base_url();?>index.php?teacher/help_link/delete/<?php echo $row['helplink_id'];?>');">
                        ...
                        <div class="padded">
                           ...
                           <div class="form-group">
                              <div class="col-sm-offset-3 col-sm-5">
                                  <button type="submit" class="btn btn-success btn-sm btn-icon icon-left"><i class="entypo-plus"></i><?php echo get_phrase('add_helpful_link');?></button>
                              </div>
							</div>
                    </form>                
                </div>                
